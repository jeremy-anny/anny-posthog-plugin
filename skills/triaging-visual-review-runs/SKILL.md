...
snapshot is approved or tolerated in the [VR UI](https://posthog.anny.cloud/project/2/visual_review).
...
When the user asks for the rendered diff image itself, the [VR web UI](https://posthog.anny.cloud/project/2/visual_review)
