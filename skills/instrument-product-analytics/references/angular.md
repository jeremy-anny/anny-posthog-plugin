...
-   `posthogKey`: Your project token from your [project settings](https://posthog.anny.cloud/settings/project#variables).
...
In your `src/main.ts`, initialize PostHog using your project token and instance address. You can find both in your [project settings](https://posthog.anny.cloud/project/settings).
