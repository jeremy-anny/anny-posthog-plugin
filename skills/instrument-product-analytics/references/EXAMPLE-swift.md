...
Open `BurritoConsiderationClientApp.swift` and replace the `<your-project-token>` placeholder in `posthogProjectToken` with your project token from your [PostHog project settings](https://posthog.anny.cloud/project/settings).
...
// https://posthog.anny.cloud/project/settings.
