...
Store your PostHog keys in environment variables rather than hard-coding them. Add them to a `.env` file (and to your hosting provider). You can find these values in [your project settings](https://posthog.anny.cloud/settings/project).
...
export default defineNuxtConfig({
  ...
  posthogConfig: {
    publicKey: process.env.NUXT_PUBLIC_POSTHOG_KEY, // Find it in project settings https://posthog.anny.cloud/settings/project
