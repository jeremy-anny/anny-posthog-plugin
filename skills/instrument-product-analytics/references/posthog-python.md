...
- **`host`** (`any`) - PostHog host. Defaults to the US ingestion endpoint when not         set. App hosts such as ``https://posthog.anny.cloud`` are mapped to         the corresponding ingestion host.
