...
evidence:
  - source_id: 9aBcDeF
    description: >
      [Daily signups](https://posthog.anny.cloud/project/41233/insights/9aBcDeF), on the
      [Growth dashboard](https://posthog.anny.cloud/project/41233/dashboard/8123): yesterday 412 vs
  ...
  - source_id: aB12cD34
    description: >
      [Write-up](https://posthog.anny.cloud/project/41233/notebooks/aB12cD34) with the -63d chart,
...
summary: |
  ...
  The scored series is [Daily signups](https://posthog.anny.cloud/project/41233/insights/9aBcDeF),
  pinned to the [Growth dashboard](https://posthog.anny.cloud/project/41233/dashboard/8123).
  ...
  **Hypothesis** — likely a broken signup flow or a tracking regression from a recent deploy.
  ...
  [notebook](https://posthog.anny.cloud/project/41233/notebooks/aB12cD34).
```
