...
2.  2
    ...
    Add your environment variables to your `.env.local` file and to your hosting provider (e.g. Vercel, Netlify, AWS). You can find your project token and host in [your project settings](https://posthog.anny.cloud/settings/project). If you're using Vite, prefixing variable names with `VITE_` ensures they are accessible in the frontend.
...
4.  ## Verify client-side events are captured
    ...
    *Confirm that you can capture client-side events and see them in your PostHog project*
    ...
    You should see these events in a minute or two in the [activity tab](https://posthog.anny.cloud/activity/explore).
