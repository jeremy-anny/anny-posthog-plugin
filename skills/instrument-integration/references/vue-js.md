...
1.  A [PostHog account](https://posthog.anny.cloud/signup)
...
Start by creating a `plugins` folder and adding a `posthog.js` file to that folder. In `posthog.js`, initialize PostHog using the `install` method with your project token and host. You can find these in your [project settings](https://posthog.anny.cloud/project/settings).
