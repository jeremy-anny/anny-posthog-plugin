...
And then include it with your project token and host (which you can find in [your project settings](https://posthog.anny.cloud/settings/project)):
...
You can configure "replay triggers" in your [project settings](https://posthog.anny.cloud/project/settings). You can configure triggers to enable or pause session recording when the user visit a page that matches the URL(s) you configure.
