...
VITE_POSTHOG_HOST=https://posthog.anny.cloud
```
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.posthogService.init(environment.posthogKey, {
      api_host: '/ingest',
      ui_host: environment.posthogHost || 'https://posthog.anny.cloud',
...
NG_APP_POSTHOG_HOST=https://posthog.anny.cloud
...
export const environment = {
  ...
  posthogHost: import.meta.env['NG_APP_POSTHOG_HOST'] || 'https://posthog.anny.cloud',
};
