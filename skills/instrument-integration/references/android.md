...
To set up [session replay](/docs/session-replay/mobile.md) in your project, all you need to do is install the Android SDK, enable "Record user sessions" in [your project settings](https://posthog.anny.cloud/settings/project-replay) and enable the `sessionReplay` option.
