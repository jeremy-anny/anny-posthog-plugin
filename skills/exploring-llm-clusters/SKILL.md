...
- **Clusters overview**: `https://posthog.anny.cloud/ai-observability/clusters`
- **Specific run**: `https://posthog.anny.cloud/ai-observability/clusters/<url_encoded_run_id>`
- **Cluster detail**: `https://posthog.anny.cloud/ai-observability/clusters/<url_encoded_run_id>/<cluster_id>`
