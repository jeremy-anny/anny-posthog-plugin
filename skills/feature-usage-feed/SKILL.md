...
[
  ...
  },
  {
    ...
    "elements": [
      {
        "url": "https://posthog.anny.cloud/project/<project_id>/ai-observability/traces/{event.properties.$ai_trace_id}?event={event.properties.$ai_target_event_id}",
        "text": { "text": "View Trace", "type": "plain_text" },
        "type": "button"
      },
      {
        "url": "https://posthog.anny.cloud/project/<project_id>/replay/{event.properties.$session_id}",
