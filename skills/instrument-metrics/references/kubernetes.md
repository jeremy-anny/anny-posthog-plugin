...
2.  2
    ...
    You can find your project token in [Project Settings](https://posthog.anny.cloud/settings).
...
5.  5
    ...
    2.  Open [**Metrics**](https://posthog.anny.cloud/metrics) in PostHog and pick a metric from the name picker
    ...
    [View your metrics in PostHog](https://posthog.anny.cloud/metrics)
