...
-   Verify you're using the correct project token from [Project Settings](https://posthog.anny.cloud/settings/project)
...
-   Find it in [Project Settings](https://posthog.anny.cloud/settings/project)
