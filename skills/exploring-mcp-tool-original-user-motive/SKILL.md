...
Build the link as `https://posthog.anny.cloud/project/<project_id>/ai-observability/traces/<trace_id>`. The query params the UI adds when you click through are optional.
