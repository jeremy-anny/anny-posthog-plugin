...
This guide covers how to find the most relevant, urgent, and impactful issues in your error tracking using the [issues page](https://posthog.anny.cloud/error_tracking).
...
You can use the search bar at the top of the [issue page](https://posthog.anny.cloud/error_tracking) to filter issues based on the properties of the exceptions in that issue.
...
If you find your queries timing out or taking more than 30 seconds, please [let us know in-app](https://posthog.anny.cloud/#panel=support%3Afeedback%3Aerror_tracking%3Alow%3Atrue)! We're always looking for benchmarks to improve against.
