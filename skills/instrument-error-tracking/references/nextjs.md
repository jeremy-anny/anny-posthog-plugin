...
5.  5
    ...
    You can enable exception autocapture for the JavaScript Web SDK in the **Error tracking** section of [your project settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture).
...
6.  6
    ...
    For the backend, we can create a `lib/posthog-server.js` file. In it, initialize PostHog from `posthog-node` as a singleton with your project token and host from [your project settings](https://posthog.anny.cloud/settings/project).
...
7.  ## Verify server-side exceptions
    ...
    [Check for server events in PostHog](https://posthog.anny.cloud/activity/explore)
...
9.  ## Verify error tracking
    ...
    *Confirm events are being sent to PostHog*
    ...
    [Check for exceptions in PostHog](https://posthog.anny.cloud/activity/explore)
