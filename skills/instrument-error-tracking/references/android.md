...
4.  4
    ...
    **Client-side configuration only**
    ...
    Support for remote configuration in the [error tracking settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture) requires SDK version 3.32.0 or higher.
