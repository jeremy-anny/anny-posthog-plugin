...
2.  2
    ...
    You can find your project token and instance address in the [project settings](https://posthog.anny.cloud/settings/project) page in PostHog.
...
7.  ## Verify error tracking
    ...
    Trigger a test exception to confirm events are being sent to PostHog. You should see them appear in the [Error Tracking](https://posthog.anny.cloud/error_tracking) tab.
