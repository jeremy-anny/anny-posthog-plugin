...
8.  ## Verify error tracking
    ...
    Trigger a test exception to confirm errors are being sent to PostHog. You should see them appear in the [Error Tracking](https://posthog.anny.cloud/error_tracking) tab.
