...
4.  4
    ...
    **Client-side configuration only**
    ...
    Support for remote configuration in the [error tracking settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture) requires SDK version 4.35.0 or higher.
    ...
    **Capturing native crashes**
    ...
    2.  Your project's **Enable exception autocapture** setting enabled in [error tracking settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture) — the same server-side setting that gates JavaScript autocapture.
