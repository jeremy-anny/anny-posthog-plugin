...
Error tracking enables you to assign issues to specific PostHog [roles](https://posthog.anny.cloud/settings/organization-roles) or teammates. This helps your team find relevant issues through **filtering**. You can also set up team-specific **alerting** to notify them when assigned issues are created or reopened.

## Assign issues

You can manually assign issues as you triage them in the UI, either from the issue list or an issue's details page.

From your error tracking [issue list](https://posthog.anny.cloud/error_tracking), click the **Unassigned** selector under any issue to assign it to a role or user.
...
Want to assign issues to a **team** rather than an individual teammate? You can create a role in [your project settings](https://posthog.anny.cloud/settings/organization-roles).
...
> If you use another issue tracking system and would like to request it, [let us know in-app](https://posthog.anny.cloud#panel=support%3Afeedback%3Aerror_tracking%3Alow%3Atrue).
