...
1.  1
    ...
    export default defineNuxtConfig({
      ...
      posthogConfig: {
        publicKey: '<ph_project_token>', // Find it in project settings https://posthog.anny.cloud/settings/project
        ...
        sourcemaps: {
          enabled: true,
          projectId: '<ph_project_id>', // Your project ID, found in your environment settings: https://posthog.anny.cloud/settings/environment#variables
          personalApiKey: '<ph_personal_api_key>', // Your personal API key from PostHog settings https://posthog.anny.cloud/settings/user-api-keys (requires organization:read and error_tracking:write scopes)
