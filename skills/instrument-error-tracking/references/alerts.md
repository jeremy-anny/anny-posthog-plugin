...
To create a real time destination, go to the [data pipelines tab](https://posthog.anny.cloud/data-management/destinations) in PostHog, click **\+ New**, and then select **Destination**. Choose your destination and press **\+ Create**.
...
If you'd like a destination to be added that we don't yet support, [let us know in-app](https://posthog.anny.cloud/#panel=support%3Afeedback%3Aerror_tracking%3A%3Afalse).
