...
4.  4
    ...
    **Remote configuration**
    ...
    Exception autocapture can also be managed remotely via the [error tracking settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture).
