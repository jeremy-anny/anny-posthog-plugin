...
4.  4
    ...
    **Client-side configuration only**
    ...
    This configuration is client-side only. Support for remote configuration in the [error tracking settings](https://posthog.anny.cloud/settings/project-error-tracking#exception-autocapture) will be added in a future release.
