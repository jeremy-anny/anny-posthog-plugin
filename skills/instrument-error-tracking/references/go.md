...
4.  4
    ...
    Trigger a test exception to confirm events are being sent to PostHog. You should see them appear in the [activity feed](https://posthog.anny.cloud/activity/explore).
