...
1.  1
    ...
    **Full working examples**
    ...
    See the complete [Node.js](https://github.com/PostHog/posthog-js/tree/main/examples/example-ai-fireworks-ai) and [Python](https://github.com/PostHog/posthog-python/tree/master/examples/example-ai-fireworks-ai) examples on GitHub.
...
2.  2
    ...
    Create a PostHog client, then swap in PostHog's OpenAI wrapper, pointed at Fireworks AI.
...
3.  3
    ...
    When you use the wrapped client to call Fireworks AI, PostHog automatically captures an `$ai_generation` event.
