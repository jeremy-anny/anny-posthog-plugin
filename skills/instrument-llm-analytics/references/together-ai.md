...
# Together AI Observability installation - Docs
...
1.  1
    ...
    **Full working examples**
    ...
    See the complete [Node.js](https://github.com/PostHog/posthog-js/tree/main/examples/example-ai-together-ai) and [Python](https://github.com/PostHog/posthog-python/tree/master/examples/example-ai-together-ai) examples on GitHub.
...
2.  2
    ...
    Create a PostHog client, then swap in PostHog's OpenAI wrapper, pointed at Together AI.
...
3.  3
    ...
    When you use the wrapped client to call Together AI, PostHog automatically captures an `$ai_generation` event.
...
5.  ## Verify traces and generations
    ...
    *Confirm LLM events are being sent to PostHog*
    ...
    [Check for LLM events in PostHog](https://posthog.anny.cloud/ai-observability/generations)
