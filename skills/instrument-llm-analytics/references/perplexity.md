...
# Perplexity AI Observability installation - Docs
...
1.  1
    ...
    **Full working examples**
    ...
    See the complete [Node.js](https://github.com/PostHog/posthog-js/tree/main/examples/example-ai-perplexity) and [Python](https://github.com/PostHog/posthog-python/tree/master/examples/example-ai-perplexity) examples on GitHub.
...
2.  2
    ...
    Create a PostHog client, then swap in PostHog's OpenAI wrapper, pointed at Perplexity.
...
3.  3
    ...
    When you use the wrapped client to call Perplexity, PostHog automatically captures an `$ai_generation` event.
