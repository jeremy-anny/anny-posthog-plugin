...
3.  3
    ...
    Initialize PostHog with your project token and host from [your project settings](https://posthog.anny.cloud/settings/project). Then call `instrument()` to register PostHog tracing with the OpenAI Agents SDK. This automatically captures all agent traces, spans, and LLM generations.
