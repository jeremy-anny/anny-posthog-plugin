...
3.  3
    ...
    Configure PostHog by setting your project token and host as well as adding `posthog` to your LiteLLM callback handlers. You can find your project token in [your project settings](https://posthog.anny.cloud/settings/project).
    ...
    os.environ["POSTHOG_API_URL"] = "https://us.i.posthog.com"  # Optional, defaults to https://posthog.anny.cloud
