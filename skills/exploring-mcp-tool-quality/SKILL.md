...
- **Dashboard**: `https://posthog.anny.cloud/project/<project_id>/mcp-analytics/dashboard`
- **Tool quality**: `https://posthog.anny.cloud/project/<project_id>/mcp-analytics/tool-quality`
