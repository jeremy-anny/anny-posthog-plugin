...
1.  A PostHog instance (either [Cloud](https://posthog.anny.cloud/signup) or [self-hosted](/docs/self-host.md))
...
Add your environment variables to your `.env.local` file and to your hosting provider (e.g. Vercel, Netlify, AWS). You can find your project token in your [project settings](https://posthog.anny.cloud/project/settings).
